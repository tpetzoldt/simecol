...
Berkeley Madonna\footnote{\url{https://berkeley-madonna.myshopify.com/}},
VENSIM\footnote{\texttt{https://vensim.com/}},
...
SWARM\footnote{\url{http://www.swarm.org/wiki/Main_Page}} for agent-based simulations.
...
\citep{Rcore2026}. Such languages allow a more interactive development
