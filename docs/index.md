...
Quick links: [Author](https://www.tu-dresden.de/Members/thomas.petzoldt) +++ [CRAN](https://cran.r-project.org/package=simecol)
...
* simecol depends on the [deSolve](https://cran.r-project.org/package=deSolve) package for numerical integration.
...
``` r
library("devtools")
install_github("https://github.com/tpetzoldt/simecol")
```
...
[Thomas Petzoldt](https://www.tu-dresden.de/Members/thomas.petzoldt), Technische Universit?t Dresden, Institute of Hydrobiology
...
<div style="text-align: right">2025-04-23</div>
